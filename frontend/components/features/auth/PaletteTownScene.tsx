...
export default function PaletteTownScene() {
  return (
    ...
    >
      ...
      {/* 풀 (2s 흔들림) */}
      <div className="absolute bottom-[37%] left-[22%]"><Grass /></div>
      <div className="absolute bottom-[37%] left-[48%]"><Grass /></div>
      <div className="absolute bottom-[37%] right-[20%]"><Grass /></div>
  ...
  return (
    <div className="relative w-10 h-10 flex items-center justify-center">
      ...
      <div
        ...
        style={{ animationDuration: "0.5s", transform: "rotate(-20deg)" }}
      />
      {/* 눈 */}
  ...
  return (
    <div className="flex items-end gap-0.5">
      {[0, 1, 2].map((i) => (
        <div
          key={i}
          className="animate-grass-sway origin-bottom"
